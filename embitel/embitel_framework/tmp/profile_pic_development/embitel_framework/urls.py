...
urlpatterns = patterns('',
    ...
    # url(r'^login/', include('django.contrib.auth.urls')),
     ...
     url(r'^embitel/urbanairship/register_device/$', 'embitel_framework.views.register_urbanairship_devices', name='register_urbanairship_devices'),
     ...
     url(r'^embitel/spp/', 'embitel_framework.views.set_profile_pic', name="send bulk PN"),
