...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P12Certificate.user'
        db.add_column(u'embitel_framework_p12certificate', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P12Certificate.user'
        db.delete_column(u'embitel_framework_p12certificate', 'user_id')
