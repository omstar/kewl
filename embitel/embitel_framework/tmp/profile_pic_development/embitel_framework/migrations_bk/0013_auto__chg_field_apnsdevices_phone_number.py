...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'embitel_framework_apnsdevices', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'APNSDevices.phone_number'
        db.alter_column(u'embitel_framework_apnsdevices', 'phone_number', self.gf('django.db.models.fields.BigIntegerField')(null=True))
