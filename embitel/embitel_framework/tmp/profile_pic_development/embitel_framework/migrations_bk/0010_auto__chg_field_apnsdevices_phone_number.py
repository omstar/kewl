...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APNSDevices.phone_number'
        db.alter_column(u'embitel_framework_apnsdevices', 'phone_number', self.gf('django.db.models.fields.IntegerField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'APNSDevices.phone_number'
        db.alter_column(u'embitel_framework_apnsdevices', 'phone_number', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        u'embitel_framework.apnsdevices': {
            ...
            'phone_number': ('django.db.models.fields.IntegerField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
