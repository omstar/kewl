...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'P12Certificate.app_name'
        db.add_column(u'embitel_framework_p12certificate', 'app_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'P12Certificate.app_name'
        db.delete_column(u'embitel_framework_p12certificate', 'app_name')
