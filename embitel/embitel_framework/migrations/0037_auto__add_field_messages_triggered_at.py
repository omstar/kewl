...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.triggered_at'
        db.add_column(u'embitel_framework_messages', 'triggered_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.triggered_at'
        db.delete_column(u'embitel_framework_messages', 'triggered_at')
    ...
    models = {
        ...
        u'embitel_framework.apnsdevices': {
            ...
            'last_heartbeat': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 19, 0, 0)'}),
        ...
        u'embitel_framework.messages': {
            ...
            'triggered_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'})
        },
