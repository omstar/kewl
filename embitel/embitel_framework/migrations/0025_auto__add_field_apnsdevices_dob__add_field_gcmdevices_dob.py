...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevices.dob'
        db.add_column(u'embitel_framework_apnsdevices', 'dob',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'GCMDevices.dob'
        db.add_column(u'embitel_framework_gcmdevices', 'dob',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevices.dob'
        db.delete_column(u'embitel_framework_apnsdevices', 'dob')

        # Deleting field 'GCMDevices.dob'
        db.delete_column(u'embitel_framework_gcmdevices', 'dob')
