...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Groups.dob'
        db.alter_column(u'embitel_framework_groups', 'dob', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Groups.dob'
        db.alter_column(u'embitel_framework_groups', 'dob', self.gf('django.db.models.fields.DateTimeField')(null=True))
