...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.from_phone_number'
        db.add_column(u'embitel_framework_messages', 'from_phone_number',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.from_phone_number'
        db.delete_column(u'embitel_framework_messages', 'from_phone_number')
