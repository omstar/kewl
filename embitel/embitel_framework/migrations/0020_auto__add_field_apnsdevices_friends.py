...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevices.friends'
        db.add_column(u'embitel_framework_apnsdevices', 'friends',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevices.friends'
        db.delete_column(u'embitel_framework_apnsdevices', 'friends')
