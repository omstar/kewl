...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevices.profile_pic'
        db.add_column(u'embitel_framework_apnsdevices', 'profile_pic',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GCMDevices.profile_pic'
        db.add_column(u'embitel_framework_gcmdevices', 'profile_pic',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevices.profile_pic'
        db.delete_column(u'embitel_framework_apnsdevices', 'profile_pic')

        # Deleting field 'GCMDevices.profile_pic'
        db.delete_column(u'embitel_framework_gcmdevices', 'profile_pic')
