...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'FlatePage'
        db.delete_table(u'embitel_framework_flatepage')


    def backwards(self, orm):
        # Adding model 'FlatePage'
        db.create_table(u'embitel_framework_flatepage', (
            ('content', self.gf('tinymce.models.HTMLField')()),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'embitel_framework', ['FlatePage'])
    ...
    models = {
        ...
        u'embitel_framework.apnsdevices': {
            ...
            'last_heartbeat': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 26, 0, 0)'}),
