...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.start_time'
        db.add_column(u'embitel_framework_messages', 'start_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Messages.end_time'
        db.add_column(u'embitel_framework_messages', 'end_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Messages.subject'
        db.add_column(u'embitel_framework_messages', 'subject',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Messages.body'
        db.add_column(u'embitel_framework_messages', 'body',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.start_time'
        db.delete_column(u'embitel_framework_messages', 'start_time')

        # Deleting field 'Messages.end_time'
        db.delete_column(u'embitel_framework_messages', 'end_time')

        # Deleting field 'Messages.subject'
        db.delete_column(u'embitel_framework_messages', 'subject')

        # Deleting field 'Messages.body'
        db.delete_column(u'embitel_framework_messages', 'body')
