...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevices.email'
        db.add_column(u'embitel_framework_apnsdevices', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GCMDevices.email'
        db.add_column(u'embitel_framework_gcmdevices', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevices.email'
        db.delete_column(u'embitel_framework_apnsdevices', 'email')

        # Deleting field 'GCMDevices.email'
        db.delete_column(u'embitel_framework_gcmdevices', 'email')
