...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.location'
        db.add_column(u'embitel_framework_messages', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.location'
        db.delete_column(u'embitel_framework_messages', 'location')
