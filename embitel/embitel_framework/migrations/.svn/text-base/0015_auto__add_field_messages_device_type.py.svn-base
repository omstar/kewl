...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.device_type'
        db.add_column(u'embitel_framework_messages', 'device_type',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.device_type'
        db.delete_column(u'embitel_framework_messages', 'device_type')
