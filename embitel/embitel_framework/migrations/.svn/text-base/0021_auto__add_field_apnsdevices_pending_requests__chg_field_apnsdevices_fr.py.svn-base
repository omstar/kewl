...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevices.pending_requests'
        db.add_column(u'embitel_framework_apnsdevices', 'pending_requests',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)


        # Changing field 'APNSDevices.friends'
        db.alter_column(u'embitel_framework_apnsdevices', 'friends', self.gf('django.db.models.fields.TextField')())
        # Adding field 'GCMDevices.friends'
        db.add_column(u'embitel_framework_gcmdevices', 'friends',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)

        # Adding field 'GCMDevices.pending_requests'
        db.add_column(u'embitel_framework_gcmdevices', 'pending_requests',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevices.pending_requests'
        db.delete_column(u'embitel_framework_apnsdevices', 'pending_requests')


        # Changing field 'APNSDevices.friends'
        db.alter_column(u'embitel_framework_apnsdevices', 'friends', self.gf('django.db.models.fields.TextField')(null=True))
        # Deleting field 'GCMDevices.friends'
        db.delete_column(u'embitel_framework_gcmdevices', 'friends')

        # Deleting field 'GCMDevices.pending_requests'
        db.delete_column(u'embitel_framework_gcmdevices', 'pending_requests')
