...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field channels on 'APNSDevices'
        m2m_table_name = db.shorten_name(u'embitel_framework_apnsdevices_channels')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('apnsdevices', models.ForeignKey(orm[u'embitel_framework.apnsdevices'], null=False)),
            ('channels', models.ForeignKey(orm[u'embitel_framework.channels'], null=False))
        ))
        db.create_unique(m2m_table_name, ['apnsdevices_id', 'channels_id'])

        # Deleting field 'GCMDevices.channels'
        db.delete_column(u'embitel_framework_gcmdevices', 'channels')

        # Adding M2M table for field channels on 'GCMDevices'
        m2m_table_name = db.shorten_name(u'embitel_framework_gcmdevices_channels')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gcmdevices', models.ForeignKey(orm[u'embitel_framework.gcmdevices'], null=False)),
            ('channels', models.ForeignKey(orm[u'embitel_framework.channels'], null=False))
        ))
        db.create_unique(m2m_table_name, ['gcmdevices_id', 'channels_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field channels on 'APNSDevices'
        db.delete_table(db.shorten_name(u'embitel_framework_apnsdevices_channels'))
        ...
        # Removing M2M table for field channels on 'GCMDevices'
        db.delete_table(db.shorten_name(u'embitel_framework_gcmdevices_channels'))
    ...
    models = {
        ...
        u'embitel_framework.apnsdevices': {
            ...
            'status_message': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
