...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'embitel_framework_messages', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('message_id', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('sent', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('delivered', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('apns_devices', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['embitel_framework.APNSDevices'], null=True, blank=True)),
            ('gcm_devices', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['embitel_framework.GCMDevices'], null=True, blank=True)),
        ...
        db.send_create_signal(u'embitel_framework', ['Messages'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'embitel_framework_messages')
    ...
    models = {
        ...
        u'embitel_framework.messages': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'delivered': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
