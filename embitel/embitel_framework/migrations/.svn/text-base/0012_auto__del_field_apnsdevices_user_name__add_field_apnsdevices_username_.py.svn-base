...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'APNSDevices.user_name'
        db.delete_column(u'embitel_framework_apnsdevices', 'user_name')

        # Adding field 'APNSDevices.username'
        db.add_column(u'embitel_framework_apnsdevices', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GCMDevices.user_name'
        db.delete_column(u'embitel_framework_gcmdevices', 'user_name')

        # Adding field 'GCMDevices.username'
        db.add_column(u'embitel_framework_gcmdevices', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'APNSDevices.user_name'
        db.add_column(u'embitel_framework_apnsdevices', 'user_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'APNSDevices.username'
        db.delete_column(u'embitel_framework_apnsdevices', 'username')

        # Adding field 'GCMDevices.user_name'
        db.add_column(u'embitel_framework_gcmdevices', 'user_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GCMDevices.username'
        db.delete_column(u'embitel_framework_gcmdevices', 'username')
