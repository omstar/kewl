...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APNSDevices.status_message'
        db.add_column(u'embitel_framework_apnsdevices', 'status_message',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'GCMDevices.status_message'
        db.add_column(u'embitel_framework_gcmdevices', 'status_message',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APNSDevices.status_message'
        db.delete_column(u'embitel_framework_apnsdevices', 'status_message')

        # Deleting field 'GCMDevices.status_message'
        db.delete_column(u'embitel_framework_gcmdevices', 'status_message')
