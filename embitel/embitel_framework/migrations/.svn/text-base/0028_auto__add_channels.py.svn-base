...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'embitel_framework_channels', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('channel_id', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('channel_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('channel_pic', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('admin', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('channel_size', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ...
        db.send_create_signal(u'embitel_framework', ['Channels'])


    def backwards(self, orm):
        # Deleting model 'Channels'
        db.delete_table(u'embitel_framework_channels')
