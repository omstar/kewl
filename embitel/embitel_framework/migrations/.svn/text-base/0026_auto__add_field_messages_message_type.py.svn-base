...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.message_type'
        db.add_column(u'embitel_framework_messages', 'message_type',
                      self.gf('django.db.models.fields.CharField')(default='message', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.message_type'
        db.delete_column(u'embitel_framework_messages', 'message_type')
