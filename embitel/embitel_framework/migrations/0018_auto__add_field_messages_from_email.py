...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.from_email'
        db.add_column(u'embitel_framework_messages', 'from_email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.from_email'
        db.delete_column(u'embitel_framework_messages', 'from_email')
