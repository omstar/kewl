...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'APNSDevices.status_message'
        db.alter_column(u'embitel_framework_apnsdevices', 'status_message', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'APNSDevices.status_message'
        db.alter_column(u'embitel_framework_apnsdevices', 'status_message', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
