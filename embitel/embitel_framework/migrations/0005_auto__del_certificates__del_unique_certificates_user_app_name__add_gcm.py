...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GCMDevices'
        db.create_table(u'embitel_framework_gcmdevices', (
            (u'gcmdevice_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['push_notifications.GCMDevice'], unique=True, primary_key=True)),
            ...
            ('api_key', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['embitel_framework.GCMApiKey'], null=True, blank=True)),
        ...
        db.send_create_signal(u'embitel_framework', ['GCMDevices'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GCMDevices'
        db.delete_table(u'embitel_framework_gcmdevices')
