...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GCMDevices.gcm_device_key'
        db.add_column(u'embitel_framework_gcmdevices', 'gcm_device_key',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GCMDevices.gcm_device_key'
        db.delete_column(u'embitel_framework_gcmdevices', 'gcm_device_key')
    ...
    models = {
        ...
        u'embitel_framework.gcmdevices': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'device_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'gcm_device_key': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
